package com.example.flink.DataStreamAPI.sink;
...
/**
 * StarRocks Sink 连接器示例
 * 将 Kafka 数据写入 StarRocks 数据库
 */
public class StarRocksSinkConnector {
    public static void main(String[] args) throws Exception {
        ...
        JdbcConnectionOptions connectionOptions = new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
                .withUrl("jdbc:mysql://node3:9030/test1")
        ...
        // 6. 执行任务
        env.execute("StarRocks Sink Connector");
    }
